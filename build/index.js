            ...
            while (1) {
                switch (_context8.prev = _context8.next) {
                    case 0:
                        _context8.t0 = body;
                        _context8.next = 3;
                        return _StudyFolder.drive.files.get({ fileId: fileId, fields: 'id,name,mimeType,modifiedTime,properties' });
...
var parentStudyFolder = exports.parentStudyFolder = function () {
    var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(_ref12) {
        ...
        var fileParents, file, parentFolder;
            ...
            while (1) {
                switch (_context9.prev = _context9.next) {
                    case 0:
                        ...
                        _context9.t0 = body;
                        _context9.next = 6;
                        return _StudyFolder.drive.files.get({ fileId: id, fields: 'id,name,parents' });
        ...
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
            while (1) {
                switch (_context10.prev = _context10.next) {
                    case 0:
                        hint = _StudyFolder.driveX.appDataFolder.readBurnHint();
                    ...
                    case 5:
                        ...
                        dbdo('onHint', { hint: hint, drive: _StudyFolder.drive, driveX: _StudyFolder.driveX });
